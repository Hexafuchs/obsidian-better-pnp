import { AROMANTIC_FLAG_ICON, ASEXUAL_FLAG_ICON, BISEXUAL_FLAG_ICON, GAY_FLAG_ICON, LESBIAN_FLAG_ICON, PANSEXUAL_FLAG_ICON, STRAIGHT_FLAG_ICON } from "src/icons/sexuality"
